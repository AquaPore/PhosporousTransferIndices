...
function PLOT(; path, Baseflow, BaseFlow_LocalMinima, Date_P, Date_Q, P, QmatchP, Q, QₓP, iiSite_P, 🎏_PlotLog1p, Pctl_Min=0.0, Pctl_Max=1.0, Width=3000, Height=400, Dpi=200)
   ...
   Fig = Figure(; size=(Width, 4 * Height), font="Sans", titlesize=30, xlabelsize=30, ylabelsize=30, labelsize=30, fontsize=30)

   Ax_1 = Axis(Fig[1, 1]; xlabel=L"$Q \ [m^{3} \ day^{-1}]$",
      xtickalign=0, ytickalign=0, xticklabelcolor=:red, xgridvisible=true, ygridvisible=true, xgridstyle=:dash, ygridstyle=:dash, yautolimitmargin=(0, 0), xscale=Scale[ii🎏_PlotLog1p], width=Width, height=Height)
   ...
   Ax_2 = Axis(Fig[1, 1]; xlabel=L"$QxP \ [g \ m^{-3} \ day^{-1}]$ ", ylabel=L"$ Cumulative \ Frequency$",
      xgridstyle=:dashdot, ygridstyle=:dashdot, xaxisposition=:top, xtickalign=0, ytickalign=0, xticklabelcolor=:blue, xgridvisible=true, ygridvisible=true, ygridcolor=:orange, yautolimitmargin=(0, 0), xscale=Scale[ii🎏_PlotLog1p], width=Width, height=Height)
   ...
   Ax_3 = Axis(Fig[2, 1]; title=iiSite_P₁, titlecolor=:navyblue, titlealign=:right, xlabel=L"$P \ [g \ m^{3}]$ ",
      ...
      ygridwidth=1, ygridvisible=true, ygridcolor=:orange, yautolimitmargin=(0, 0), xautolimitmargin=(0, 0), width=Width, height=Height)
   ...
   Ax_4 = Axis(Fig[3, 1]; xlabel=L"$Q \ [m^{3} \ day^{-1}]$",
      ...
      ygridwidth=1, ygridvisible=true, ygridcolor=:orange, yautolimitmargin=(0, 0), xautolimitmargin=(0, 0), xscale=Scale[ii🎏_PlotLog1p], width=Width, height=Height)

   scatter!(Ax_4, QmatchP, P; markersize=10, marker=:diamond, color=:blue)

   Ax_5 = Axis(Fig[4, 1]; xlabel=L"$Date$",
      ylabel=L"Q [m^{3} \ day^{-1}]", xgridstyle=:dashdot, ygridstyle=:dashdot, xtickalign=0, ytickalign=0, xticklabelcolor=:blue, xgridvisible=true, ygridwidth=1, ygridvisible=true, ygridcolor=:purple, yautolimitmargin=(0, 0), xautolimitmargin=(0, 0), xticklabelrotation=π / 2.0, width=Width, height=Height)
